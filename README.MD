...
A professional, role-based **Library Dashboard** built with **Flask**, seamlessly integrated with the **Koha Integrated Library System (ILS)**.

This system provides **real-time analytics**, **automated scheduled reports**, and **secure dashboards** for **administrators**, **heads of departments (HODs)**, and **class teachers** — enabling data-driven decision-making and streamlined academic library management.
...
> Showcase the system visually — replace the image paths below with your own screenshots from `/static/screenshots/`.

| Role                        | Screenshot                                                     |
| --------------------------- | -------------------------------------------------------------- |
| 🧭 **Admin Dashboard**      | ![Admin Dashboard](static/screenshots/admin_dashboard.png)     |
| 🏛️ **HOD Dashboard**       | ![HOD Dashboard](static/screenshots/hod_dashboard.png)         |
| 👩‍🏫 **Teacher Dashboard** | ![Teacher Dashboard](static/screenshots/teacher_dashboard.png) |
| 🧾 **Reports View**         | ![Reports View](static/screenshots/reports_view.png)           |
| 🔐 **Login Page**           | ![Login Page](static/screenshots/login_page.png)               |

*(Tip: Create a `static/screenshots/` folder and drop your images there for GitHub to render them.)*
